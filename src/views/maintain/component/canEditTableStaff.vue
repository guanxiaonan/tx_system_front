<style lang="less">
    @import '../../tables/components/editable-table.less';
</style>
        ...
        on: {
            'click': () => {
                if (!currentRow.editting) {
                    ...
                    /////////////////////////////////////////////////在此修改数据库的数据////////////////////////////////
                    axios.put(`api/material/update_staff`,vm.thisTableData[index]).then((res) => {
                       console.log(res)
                    });
                }
            }
...
const deleteButton = (vm, h, currentRow, index) => {
    return h('Poptip', {
        ...
        on: {
            'on-ok': () => {
                /////////////////////////////////////////////////在此删除数据库的数据////////////////////////////////
                var i =vm.thisTableData[index].staffId;
                vm.thisTableData.splice(index, 1);
                vm.$emit('input', vm.handleBackdata(vm.thisTableData));
                vm.$emit('on-delete', vm.handleBackdata(vm.thisTableData), index);
                axios.delete(`api/material/delete_staff/${i}`).then((res) => {
                    console.log(res)
                })
            }
        }
...
export default {
    ...
    methods: {
        ...
        //         staffPhone: i.staffPhone,
        //         staffJob: i.staffJob,
        //         staffDept: i.staffDept
        //     }
        // }
    },
    watch: {
