            ...
            <row>
                <Col span='12' class="padding-right1">
                    ...
                    <Form :model="formItem" :label-width="80" style="width:100%;dispaly:block;">
                        ...
                        <FormItem label="地址" style="width: 500px">
                        ...
                        <FormItem label="锅名" style="width: 300px">
                            <Input v-model="potName" ></Input>
                        </FormItem>
                        <FormItem label="损坏描述"><Input v-model="formItem.describe" placeholder="请输入..." style="width: 420px"></Input>
                        </FormItem>
    ...
    export default {
        ...
        data () {
            return {
                ...
                formItem: {
                    ...
                    potNameId: this.$route.params.potNameId,
                ...
                //     handleRemark: ''
                // },
                potName: this.$route.params.potName,
                customer: '',
                username: '',
                dealerNameList: [],
                potNameList: [],
                ...
                moreAddress: '',
                pot: '天喜',
                showPic: require('../../commodity/images/'+this.$route.params.potName + '.jpg'),
                k: [],
                problemDescribe: {
                    airFryingPan: {
                        title: "光波炉"
        ...
        methods: {
            ...
            handleSubmit: function () {
                ...
                axios.put('/api/material/update_repairHandle', this.formItem, {
                    headers: {
                        'Content-Type': 'application/json'
                    }
                }).then((response) => {
                    console.log(this.formItem.describe);
                    console.log(response);
